...
/* ------------------------------------------------------------------------------------------------*/
//Funcion enviar whatsapp - Form de contacto

$("#wsp_contact_form").submit(function() {
    event.preventDefault();
    
    window.open('https://wa.me/'+$("#seller-phone").val()+'?text=Hola! Soy *'+$("#contact-name").val()+'*. Quiero hacerte la siguiente consulta por tu publicación de un ** en Usados San Juan. \n '+$("#contact-mensaje").val(),'_blank');
    $("#contact-name").val('');
    $("#contact-mensaje").val('');
});
